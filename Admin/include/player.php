...
class player {
	...
	public function addItem($accountId, $itemCode, $itemCount, $type = SERVER_NAME){
	...
	public function getCharacterData($accountId) {
		$query = new querydbSQL();
		return $query->SelectW(DB_TELECASTER, "Character", array("account_id" => $accountId));
	}
}